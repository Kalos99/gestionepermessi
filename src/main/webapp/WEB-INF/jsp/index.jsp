				  ...
				  <div class="container px-4 py-5" id="featured-3">
				    <div class="row g-4 py-5 row-cols-1 row-cols-lg-2">
				      <div class="feature col">
					    ...
					    <a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/utente/search"">Vai alla funzionalità</a>
				      </div>
				      <div class="feature col">
				        <div class="feature-icon bg-primary bg-gradient">
				        ...
				        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
				        <a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/dipendente/search">Vai alla funzionalità</a>
				      </div>
				    </div>
				  </div>
				</sec:authorize> 
				  ...
				  <div class="container px-4 py-5" id="featured-3">
				    <div class="row g-4 py-5 row-cols-1 row-cols-lg-2">
				      <div class="feature col">
				        ...
				        <h2>Ricerca richieste</h2>
				        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
				        <a href="${pageContext.request.contextPath}/richiesta_permesso/search" class="icon-link">
