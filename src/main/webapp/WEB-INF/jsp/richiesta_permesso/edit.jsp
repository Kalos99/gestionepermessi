			...
			<div class="container">
					...
					<div class='card'>
					    <div class='card-header'>
					        <h5>Inserisci i dati per la modifica della richiesta</h5> 
					    </div>
					    <div class='card-body'>
					    
					   		 <h6 class="card-title">I campi con <span class="text-danger">*</span> sono obbligatori</h6>
			
								<form:form method="post" modelAttribute="edit_richiesta_attr" action="${pageContext.request.contextPath }/richiesta_permesso/update" novalidate="novalidate" class="row g-3">
									<form:hidden path="id"/>
									...
									<div class="col-md-12 d-none" id="certificato">
										...
										<spring:bind path="codiceCertificato">
											<input type="text" name="codiceCertificato" id="codiceCertificato" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il codice" value="${edit_richiesta_attr.codiceCertificato }" required>
										</spring:bind>
