...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
         ...
         .antMatchers("/dipendente/edit/**", "/dipendente/update", "/messaggio/**", "/richiesta_permesso/cambiaStato/**").hasRole("BO_USER")
         .antMatchers("/dipendente/**").hasAnyRole("ADMIN", "BO_USER")
         .antMatchers("/richiesta_permesso/search", "/richiesta_permesso/list", "/richiesta_permesso/show/**", "/richiesta_permesso").hasAnyRole("BO_USER", "DIPENDENTE_USER")
